...
def test_create_link(client, sample_link_data):
    ...
    assert data["short_url"] == sample_link_data["short_name"]  # short_url equals short_name when unique
...
def test_update_link_short_name_with_existing_conflict(client):
    ...
    assert updated_link2["short_url"] == "link1-1"  # Suffix added because link1 already uses "link1"
